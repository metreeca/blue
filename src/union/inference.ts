 ...
 *
 * Resolves the alternatives a union describes: `Branch` yields every branch at once, so that the value of a union is
 * resolved by resolving each branch in turn.
 *
 * @module
 */
