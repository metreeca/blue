...
- **Breaking:** Reject `foreign` reference entries during resource validation — foreign links are managed by the target
  resource and are not part of the source resource state; mixed unions exclude foreign variants from validation
